...
import type { InfoAttivita, ServiziData, BrandData, TeamData, FaqData } from './types';
...
export class MockDataService {
  ...
  readonly brand$: Observable<BrandData> = this.http
    .get<BrandData>('/assets/mock/brand.json')
    .pipe(shareReplay(1));
