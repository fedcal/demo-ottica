  ...
  template: `
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home — Ottica Visus">
          <span class="brand__icon" aria-hidden="true">👓</span>
          <span class="brand__text">Ottica Visus</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          ...
          <a routerLink="/brand" routerLinkActive="is-active">Brand</a>
          <a routerLink="/chi-siamo" routerLinkActive="is-active">Chi siamo</a>
          <a routerLink="/contatti" routerLinkActive="is-active" class="cta">Prenota Esame</a>
        </nav>
      </div>
    </header>
  `,
