...
URL: `https://ottica.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `ottica.demo.federicocalo.dev`
...
- Output directory: `dist/ottica/browser`
...
URL: `https://fedcal.github.io/federico-demo-ottica/`
...
- `base: /federico-demo-ottica/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `ottica-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   ottica-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `ottica-docs.federicocalo.dev`
